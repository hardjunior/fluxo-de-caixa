							...
							<div class="form-group">														
								<div class="col-sm-8">
									...
									<div class="input-group">
								      	...
								      	<input type="hidden" name="idUsuario" id="idUsuario" value="<?= (!empty($arrDados["idUsuario"])) ?$arrDados["idUsuario"]:''; ?>" />
								      	<input type="hidden" name="acao" id="acao" value="E" />								      	
								      	<input type="text" class="form-control" name="NmUsuario" id="NmUsuario" placeholder="Nome" maxlength="100" disabled="none" value="<?= (!empty($objRow['NmUsuario'])) ? $objRow['NmUsuario'] :''; ?>">
								      	<input type="hidden" class="form-control" name="NmUsuario" id="NmUsuario" placeholder="Nome" maxlength="100" value="<?= (!empty($objRow['NmUsuario']))?$objRow['NmUsuario']:''; ?>">
       						...
       						<div class="form-group">					
								<div class="col-sm-8">
									...
									<div class="input-group">
								      	...
								      	<input type="text" class="form-control" name="DsEmail" id="DsEmail" placeholder="Email" maxlength="255" disabled="none" value="<?= (!empty($objRow['DsEmail'])) ? $objRow['DsEmail'] : ''; ?>">
								      	<input type="hidden" class="form-control" name="DsEmail" id="DsEmail" placeholder="Email" maxlength="255" value="<?= (!empty($objRow['DsEmail'])) ? $objRow['DsEmail'] : ''; ?>">
