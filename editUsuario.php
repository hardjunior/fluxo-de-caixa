							...
							<div class="form-group">														
								<div class="col-sm-8">
									...
									<div class="input-group">
								      	...
								      	<input class="form-control" name="NmUsuario" id="NmUsuario" type="text" placeholder="Nome" maxlength="100" value="<?= (!empty($objRow['NmUsuario'])) ? $objRow['NmUsuario'] : ''; ?>">
       						...
       						<div class="form-group">					
								<div class="col-sm-8">
									...
									<div class="input-group">
								      	...
								      	<input class="form-control" name="DsEmail" id="DsEmail" type="text" placeholder="Email" maxlength="255" value="<?= (!empty($objRow['DsEmail'])) ? $objRow['DsEmail'] : ''; ?>">
