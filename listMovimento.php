...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Movimentos Inseridos</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
            ...
            <div class="panel panel-default">
                ...
                <form id="form" name="form" method="post" accept-charset="listMovimento.php">
                	<label for="fltMovimento">Pesquisar</label>
				 	<input class="form-control" name="fltMovimento" id="fltMovimento" placeholder="insira sua pesquisa.." value="<?= (!empty($arrDados["fltMovimento"])) ? $arrDados["fltMovimento"]:''; ?>">
				</form>
			    ...
			    <div class="table-responsive">
			        <table class="table table-striped table-bordered table-hover">
						...
						<?php
						//if (!empty($arrDados["fltMovimento"]))						
							$arrDados["fltMovimento"] = (!empty($arrDados["fltMovimento"])) ? mysqli_real_escape_string($connecta,$arrDados["fltMovimento"]):'';					
							$strSQL = "SELECT 	
										...
										WHERE 
												1=1 and u.idUsuario ='".$_SESSION['idUsuario']."'";
							...
							$objRs = mysqli_query($connecta,$strSQL) or die("Erro ao buscar Movimento");								
							...
							{	
								...
								echo "<td>";
									echo (!empty($objRow['FgTipo'])) and $objRow['FgTipo'] === 'D' ? 'Despesa': 'Receita';
								echo "</td>";
								echo "<td>";
